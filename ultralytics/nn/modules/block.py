...
class Bottleneck(nn.Module):
    def __init__(
        ...
        k: tuple[int, int] = (3, 3),
        e: float = 0.5,
        use_simam: bool = False,   # default OFF
    ):
        super().__init__()
        c_ = int(c2 * e)
...
class C3k2(C2f):
    ...
    def __init__(
        ...
        self.m = nn.ModuleList(
            C3k(self.c, self.c, 2, shortcut, g) if c3k else Bottleneck(self.c, self.c, shortcut, g, use_simam=False) for _ in range(n)
        )
